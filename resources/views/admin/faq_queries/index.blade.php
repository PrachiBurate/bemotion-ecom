...
<div class="page-header d-flex justify-content-between align-items-center">
     <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">FAQ Queries</h5>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ url('/dashboard') }}">Home</a>
            </li>
            <li class="breadcrumb-item">FAQ Queries</li>
        </ul>
    </div>
...
<tr>
    ...
    <td class="d-flex gap-2">
        ...
        {{-- MARK AS READ --}}
        @if(!$q->status && ($user->hasPermission('faq_queries.update') || $user->is_admin))
        <form method="POST" action="/admin/faq-queries/status/{{ $q->id }}">
            @csrf
