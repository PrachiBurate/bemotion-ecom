...
<section class="page-banner">
   <div class="page-banner-wrapper p-r z-1">
                    ...
                    <div class="page-image"><img src="{{ asset('assets/images/banner/'.$banner->image) }}" alt="image" width="600" height="400"></div>
...
<div class="contact-wrapper p-r z-1 mb-50" 
    ...
    <div class="shape shape-one">
        <span><img src="{{ asset('assets/images/shape/cl-line.png') }}" alt=""></span>
    </div>

    <h3>Bulk Order Request</h3>
    <p class="mb-4">Fill the form below and our team will contact you shortly.</p>
    ...
    <form class="pesco-contact-form" method="POST" action="{{ route('bulk.order.submit') }}">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <input type="email" name="email" class="form_control" placeholder="Your Email" required>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <input type="text" name="phone" class="form_control" placeholder="Phone Number" required>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <textarea name="message" class="form_control" placeholder="Your Requirement (optional)" rows="6"></textarea>
            </div>
        </div>
...
<div class="col-lg-4">
    <div class="contact-img-text text-center mb-50 d-none d-lg-block"
         data-aos="fade-left" data-aos-delay="15" data-aos-duration="1500">

        <img src="{{ asset('assets/images/contact/text-img.png') }}" alt="">
    </div>
</div>
