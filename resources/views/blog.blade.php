...
@endphp
    ...
    @if($banner && $banner->image)
        <img src="{{ asset('assets/images/banner/'.$banner->image) }}" alt="banner" width="675" height="408">
    @else
...
@endif
    ...
    <input type="email" class="form_control" name="email" placeholder="Enter Email Address" required>
