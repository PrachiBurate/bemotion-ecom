...
<!-- BANNER -->
  ...
  <section class="page-banner">
                ...
                <div class="page-banner-wrapper p-r z-1">
                    ...
                    <div class="page-image">  <img src="{{ asset('assets/images/blog/'.$blog->image) }}" width="600" height="400" alt="image"></div>
...
<!-- ================= COMMENTS ================= -->
<div class="pesco-comment-area mb-40">
<h4 class="mb-40">Total Reviews ({{ count($comments) }})</h4>
...
<!-- ================= COMMENT FORM ================= -->
<div class="pesco-contact-area mb-50">
<h4>Write Comment</h4>
...
<form class="pesco-contact-form" action="{{ url('/blog/comment') }}" method="POST">
@csrf
...
<div class="col-lg-12">
<textarea class="form_control" placeholder="Write Comment" name="message"></textarea>
</div>
...
<!-- SEARCH -->
<!-- <div class="sidebar-widget sidebar-search-widget mb-50">
<h4 class="widget-title">Search</h4>

<form method="GET" action="{{ url('/blog') }}">
<input type="search" name="search" class="form_control" placeholder="Search" required>
</form>
...
<li class="post-thumbnail-content">
    <img src="{{ asset('assets/images/blog/'.$r->image) }}">
...
<!-- NEWSLETTER -->
<div class="sidebar-newsletter-widget mb-40">
