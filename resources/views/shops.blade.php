                            ...
                            <div class="shop-sidebar-area">
                                ...
                                <div class="sidebar-banner-widget mb-40" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                                    <div class="banner-widget-content">
                                        <div class="banner-shape"><img src="assets/images/widget/banner-shape-1.png" alt="shape"></div>
                                        <div class="banner-img"><img src="assets/images/widget/banner-1.png" alt="image"></div>
                                        <div class="content">
                                            <span class="sale">BIG SALE</span>
                                            <h3>40% <span>off Each Products</span></h3>
                                            <a href="{{ url ('/shops') }}" class="theme-btn style-one">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="shop-page-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="30" data-aos-duration="600">
                                            <div class="product-thumbnail">
                                            ...
                                            <div class="product-info-wrap">
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title"><a href="{{ url('shop-details') }}">Cozy knit sweater with pockets</a></h4>
                                                </div>
                                                <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="35" data-aos-duration="800">
                                            <div class="product-thumbnail">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="40" data-aos-duration="1000">
                                            <div class="product-thumbnail">
                                                <img src="assets/images/products/product-1.png" alt="Products">
                                                <div class="discount">10% Off</div>
                                                <div class="hover-content">
                                                    <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                    <a href="assets/images/products/product-1.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div class="cart-button">
                                                    <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                                </div>
                                            ...
                                            <div class="product-info-wrap">
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title"><a href="{{ url('shop-details') }}">Classic leather biker jacket with zippers</a></h4>
                                                </div>
                                                <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="45" data-aos-duration="1200">
                                            <div class="product-thumbnail">
                                                <img src="assets/images/products/product-2.png" alt="Products">
                                                <div class="discount">10% Off</div>
                                                <div class="hover-content">
                                                    <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                    <a href="assets/images/products/product-2.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div class="cart-button">
                                                    <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1400">
                                            <div class="product-thumbnail">
                                                <img src="assets/images/products/product-3.png" alt="Products">
                                                <div class="discount">10% Off</div>
                                                <div class="hover-content">
                                                    <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                    <a href="assets/images/products/product-3.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div class="cart-button">
                                                    <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                                </div>
                                            ...
                                            <div class="product-info-wrap">
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title"><a href="{{ url('shop-details') }}">Relaxed fit denim jeans with distressing</a></h4>
                                                </div>
                                                <div class="product-price">
                                                    <span class="price prev-price"><span class="currency">$</span>50.00</span>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="55" data-aos-duration="1600">
                                            <div class="product-thumbnail">
                                            ...
                                            <div class="product-info-wrap">
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title"><a href="{{ url('shop-details') }}">Cargo shorts with pockets and drawstring</a></h4>
                                                </div>
                                                <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="60" data-aos-duration="1800">
                                            <div class="product-thumbnail">
                                                <img src="assets/images/products/product-4.png" alt="Products">
                                                <div class="discount">10% Off</div>
                                                <div class="hover-content">
                                                    <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                    <a href="assets/images/products/product-4.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div class="cart-button">
                                                    <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                                </div>
                                            ...
                                            <div class="product-info-wrap">
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title"><a href="{{ url('shop-details') }}">Elegant silk dress with sequins</a></h4>
                                                </div>
                                                <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12">
                                        <!--=== Product Item  ===-->
                                        <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="65" data-aos-duration="2000">
                                            <div class="product-thumbnail">
                                                <img src="assets/images/products/product-5.png" alt="Products">
                                                <div class="discount">10% Off</div>
                                                <div class="hover-content">
                                                    <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                    <a href="assets/images/products/product-5.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div class="cart-button">
                                                    <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                                </div>
                                            ...
                                            <div class="product-info-wrap">
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title"><a href="{{ url('shop-details') }}">Cashmere v-neck sweater with ribbed cuffs</a></h4>
                                                </div>
                                                <div class="product-price">
