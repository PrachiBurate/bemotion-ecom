...
<div class="single-information-item d-flex justify-content-between mb-15">
    ...
    <div class="content mb-20">
        <h4>Phone</h4>
        <p><a href="tel:{{ $office->phone1 }}">{{ $office->phone1 }}</a></p>
        @if($office->phone2)
        <p><a href="tel:{{ $office->phone2 }}">{{ $office->phone2 }}</a></p>
        @endif
    </div>
...
@endif
                              <form class="pesco-contact-form" method="POST" action="{{ route('contact.submit') }}">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <input type="text" name="name" placeholder="Name" class="form_control" required>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <textarea class="form_control" name="message" placeholder="Write your message" cols="5" rows="9" required></textarea>
            </div>
        </div>
