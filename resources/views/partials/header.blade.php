                ...
                <div class="container">
                    ...
                    <div class="search-header-inner">
                        ...
                        <div class="site-branding">
                            <a href="{{ url('/') }}" class="brand-logo"><img src="assets/images/logo/logo-main.png" alt="Logo"></a>
                        </div>
                            ...
                            <div class="main-categories-wrap d-none d-lg-block">
                                ...
                                <div class="categories-dropdown-wrap categories-dropdown-active">
                                    <div class="categori-dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="{{ url ('/shops') }}"> <img src="assets/images/icon/shirt.png" alt="Shirts">Man Shirts</a>
                                            </li>
                                            <li>
                                                <a href="{{ url ('/shops') }}"> <img src="assets/images/icon/denim.png" alt="Jeans">Denim Jeans</a>
                                            </li>
                                            <li>
                                                <a href="{{ url ('/shops') }}"> <img src="assets/images/icon/suit.png" alt="Suit">Casual Suit</a>
                                            </li>
                                            <li>
                                                <a href="{{ url ('/shops') }}"> <img src="assets/images/icon/dress.png" alt="Dress">Summer Dress</a>
                                            </li>
                                            <li>
                                                <a href="{{ url ('/shops') }}"> <img src="assets/images/icon/sweaters.png" alt="Sweaters">Sweaters</a>
                                            </li>
                                        </ul>
                                    </div>
                                                ...
                                                <nav class="main-menu">
                                                    <ul>
                                                        ...
                                                        <li class="menu-item has-children"><a href="#">Shop</a>
                                                            <ul class="sub-menu">
                                                                <li><a href="{{ url('shops-grid') }}">Shop Grid</a></li>
                                                                <li><a href="{{ url ('/shops') }}">Shop left Sidebar</a></li>
                                                                <li><a href="{{ url('shop-right-sidebar') }}">Shop Right Sidebar</a></li>
                                                                <li><a href="{{ url('shop-details') }}">Product Details</a></li>
