                            ...
                            <div class="col-xl-3 col-sm-6">
                                ...
                                <div class="footer-widget about-company-widget mb-40" data-aos="fade-up" data-aos-delay="10" data-aos-duration="1000">
                                    <div class="widget-content">
                                        <a href="{{ url('/') }}" class="footer-logo"><img src="assets/images/logo/logo-main.png" alt="Brand Logo"></a>
                                ...
                                <div class="footer-widget footer-nav-widget mb-40" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1400">
                                    <div class="widget-content">
                                        ...
                                        <ul class="widget-menu">
                                            ...
                                            <li><img src="assets/images/icon/star-3.svg" alt="star icon"><a href="{{ url('/faq') }}">FAQ</a></li>
                                            <li><img src="assets/images/icon/star-3.svg" alt="star icon"><a href="{{ url('/contact') }}">Contact</a></li>
                                ...
                                <div class="footer-widget footer-recent-post-widget" data-aos="fade-up" data-aos-delay="25" data-aos-duration="1600">
                                    ...
                                    <div class="widget-content">
                                        <div class="recent-post-item">
                                            ...
                                            <div class="content">
                                                <h4><a href="{{ url('/blog-details')}}">Tips on Finding Affordable Fashion Gems Online</a></h4>
                                                <span><a href="{{ url('/blog-details')}}">July 11, 2023</a></span>
                                            </div>
                                        </div>
                                        <div class="recent-post-item">
                                            <div class="thumb">
                                            ...
                                            <div class="content">
                                                <h4><a href="{{ url('/blog-details')}}">Mastering the Art of Fashion E-commerce Marketing</a></h4>
                                                <span><a href="{{ url('/blog-details')}}">JUly 11, 2024</a></span>
                                            </div>
                                        </div>
                                        <div class="recent-post-item">
                                            <div class="thumb">
                                            ...
                                            <div class="content">
                                                <h4><a href="{{ url('/blog-details')}}">Must-Have Trends You Can Shop Online Now</a></h4>
                                                <span><a href="{{ url('/blog-details')}}">July 11, 2024</a></span>
                                            </div>
                                        </div>
                                    </div>
