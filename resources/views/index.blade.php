                ...
                <div class="category-slider-one" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1200">
                    ...
                    <div class="category-item style-one text-center">
                        ...
                        <div class="category-content">
                            <a href="{{ url('/') }}" class="category-btn">Man Shirts</a>
                        </div>
                    </div>
                    <!--=== Category Item ===-->
                    <div class="category-item style-one text-center">
                        ...
                        <div class="category-content">
                            <a href="{{ url('/') }}" class="category-btn">Denim Jeans</a>
                        </div>
                    </div>
                    <!--=== Category Item ===-->
                    <div class="category-item style-one text-center">
                        ...
                        <div class="category-content">
                            <a href="{{ url('/') }}" class="category-btn">Casual Suit</a>
                        </div>
                    </div>
                    <!--=== Category Item ===-->
                    <div class="category-item style-one text-center">
                        ...
                        <div class="category-content">
                            <a href="{{ url('/') }}" class="category-btn">Summer Dress</a>
                        </div>
                    </div>
                    <!--=== Category Item ===-->
                    <div class="category-item style-one text-center">
                        ...
                        <div class="category-content">
                            <a href="{{ url('/') }}" class="category-btn">Sweaters</a>
                        </div>
                    </div>
                    <!--=== Category Item ===-->
                    <div class="category-item style-one text-center">
                        ...
                        <div class="category-content">
                            <a href="{{ url('/') }}" class="category-btn">Jackets</a>
                        </div>
                    </div>
                    <!--=== Category Item ===-->
                    <div class="category-item style-one text-center">
                        ...
                        <div class="product-item style-two">
                            ...
                            <div class="product-info-wrap">
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="{{ url('shop-details') }}">Women Red & White Striped Crepe Top</a></h4>
                                </div>
                                <div class="product-price">
                        ...
                        <div class="product-item style-two">
                            ...
                            <div class="product-info-wrap">
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="{{ url('shop-details') }}">Striped cotton t-shirt with crew neck</a></h4>
                                </div>
                                <div class="product-price">
                        ...
                        <div class="product-item style-two">
                            ...
                            <div class="product-info-wrap">
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="{{ url('shop-details') }}">Quilted puffer vest with faux fur collar</a></h4>
                                </div>
                                <div class="product-price">
                                    <span class="price prev-price"><span class="currency">$</span>90.00</span>
                                    <span class="price new-price"><span class="currency">$</span>10.00</span>
