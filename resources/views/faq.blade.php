...
@section('content')
  <main class="main-bg">
    ...
    <img src="{{ asset('assets/images/banner/'.$banner->image) }}" width="640" height="400" alt="image">
</div>
...
@endif
                                <form class="pesco-contact-form" method="POST" action="{{ route('faq.submit') }}">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <input type="text" name="name" class="form_control" placeholder="Name" required>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <textarea class="form_control" name="message" placeholder="Write your question" cols="10" rows="9" required></textarea>
            </div>
        </div>
